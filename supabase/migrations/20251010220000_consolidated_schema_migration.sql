-- =======================================================================================
-- TRADEX-PRO CONSOLIDATED SCHEMA MIGRATION
-- Version: 20251010220000
-- Purpose: Unified schema consolidation for TradeX-Pro
-- =======================================================================================
-- This migration consolidates all conflicting schemas into a single, unified implementation
-- Handles both new installs and upgrades from existing migrations
-- =======================================================================================
...
-- =======================================================================================
-- CLEANUP: DROP CONFLICTING TABLES AND POLICIES
-- =======================================================================================
...
DROP TRIGGER IF EXISTS on_kyc_document_update ON public.kyc_documents;

-- Drop conflicting functions
DROP FUNCTION IF EXISTS public.handle_new_user() CASCADE;
DROP FUNCTION IF EXISTS public.handle_kyc_approval() CASCADE;

-- Drop tables that will be recreated in unified schema (in reverse dependency order)
...
DROP TABLE IF EXISTS public.kyc_status CASCADE;
...
DROP TYPE IF EXISTS public.position_side CASCADE;
...
-- =======================================================================================
-- WALLET AND FINANCIAL TABLES (RECREATE)
-- =======================================================================================
...
-- =======================================================================================
-- LEAD MANAGEMENT TABLES (RECREATE)
-- =======================================================================================
...
-- =======================================================================================
-- INDEXES FOR PERFORMANCE (RECREATE)
-- =======================================================================================
...
-- =======================================================================================
-- ENABLE ROW LEVEL SECURITY (RECREATE)
-- =======================================================================================
...
-- =======================================================================================
-- ROW LEVEL SECURITY POLICIES (RECREATE)
-- =======================================================================================
...
-- Insert some basic market data for common symbols to enable immediate trading
INSERT INTO public.market_data_cache (symbol, price, change, change_percent, volume, high, low, open, bid, ask) VALUES
  ('EUR/USD', 1.0912, 0.0021, 0.19, 250000, 1.0935, 1.0856, 1.0891, 1.0910, 1.0914),
  ('GBP/USD', 1.2918, -0.0015, -0.12, 180000, 1.2954, 1.2845, 1.2933, 1.2915, 1.2921),
  ('USD/JPY', 148.72, 0.45, 0.30, 160000, 149.15, 147.89, 148.27, 148.70, 148.74),
  ('AUD/USD', 0.6543, 0.0008, 0.12, 95000, 0.6568, 0.6489, 0.6535, 0.6540, 0.6546),
  ('USD/CAD', 1.3578, -0.0021, -0.15, 120000, 1.3612, 1.3545, 1.3599, 1.3575, 1.3581),
  ('BTC/USD', 43250.00, 1250.00, 2.98, 45000, 44500.00, 41800.00, 42000.00, 43200.00, 43300.00),
  ('ETH/USD', 2650.00, 85.00, 3.32, 28000, 2720.00, 2540.00, 2565.00, 2645.00, 2655.00)
...
-- Log the successful completion of schema consolidation
INSERT INTO public.audit_logs (action, entity_type, details)
VALUES ('schema_consolidation', 'system', '{"message": "Unified schema migration completed successfully", "version": "20251010220000"}');
